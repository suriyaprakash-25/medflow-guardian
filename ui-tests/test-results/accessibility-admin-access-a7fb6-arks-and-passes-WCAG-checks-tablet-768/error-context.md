...
- Name: accessibility.spec.ts >> admin accessibility >> authenticated shell exposes named landmarks and passes WCAG checks
- Location: tests\accessibility.spec.ts:33:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://127.0.0.1:5176/login
Call log:
  - navigating to "http://127.0.0.1:5176/login", waiting until "load"
