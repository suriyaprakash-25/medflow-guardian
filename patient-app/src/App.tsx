...
function ProtectedRoute() {
  ...
  if (authorized === null) {
    return <main className="grid min-h-screen place-items-center p-6"><div className="w-full max-w-md"><FeedbackState tone="loading" title="Restoring secure session" message="Checking your authenticated patient session." /></div></main>;
  }
