    ...
    <div className="space-y-6">
      <div className="flex justify-between items-end">
        <div>
          ...
          <p className="text-sm text-slate-500">Manage your upcoming and past clinic visits.</p>
        </div>
      </div>
            ...
            <div key={apt.id} className="bg-white rounded-lg border border-border shadow-sm p-5 hover:shadow-md transition-shadow">
              ...
              <div className="space-y-3 pt-4 border-t border-slate-100">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <p className="text-xs font-medium text-slate-700">Doctor ID: {apt.doctor_id}</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
